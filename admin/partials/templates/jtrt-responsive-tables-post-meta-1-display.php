...
// Display for the admin custom post type meta box
...
<div id="jt-editor-container">
    ...
    <header class="group">
        ...
        <ul id="jt-steps">
            <li class="active"><?php _e('Table Editor',$text_domain); ?></li>
            <li><?php _e('Table Options',$text_domain); ?></li>
            <li><?php _e('Table Styles',$text_domain); ?></li>
        </ul>
    </header>
