...
class Jtrt_Responsive_Tables {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'jtrt_tables_post' );
		$this->loader->add_action( 'add_meta_boxes', $plugin_admin, 'jtrt_table_add_meta_box_1' );
		$this->loader->add_action( 'save_post', $plugin_admin, 'myplugin_save_meta_box_data' );
