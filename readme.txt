...
Please note, if you are updating from version 1.3.2, you will need to first UNINSTALL the previous 1.3.2 version before installing v2.* If you don't delete the old version of the plugin beforehand, your tables will not show up correctly. If you have issues, please contact me via [GitHub](https://github.com/mythirdeye/jtrt-tables). Thanks!
...
* 4 Custom Breakpoint sizes! (XS SM MD LG)
...
This is a very straight forward plugin, however I have created the following resources to help you get started using my plugin. If you have any questions or comments, please contact me through github. The docs on the github is currently outdated, I am working on updating the DOCS and video tutorial for V2, please stay tuned and sorry for any inconvenience this may have caused. 

[DOCS](https://github.com/mythirdeye/jtrt-tables) | [Video Tutorial](https://youtu.be/OTxaksRothY)
...
2. [jQuery CSV to Table](https://code.google.com/p/jquerycsvtotable/)
